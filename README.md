...
本技能适用于 Codex，用来整理 Krea 2 提示词。

它可以把一句中文想法、已有提示词，或者一张参考图，整理成更适合 Krea 2 Turbo 模型使用的高密度英文提示词，并同时生成中文译文和一个带复制按钮的本地 HTML 页面。

## 适合做什么

- 生成 Krea 2 Turbo 模型使用的图片提示词
- 把普通中文想法扩写成英文长提示词
- 把已有提示词改写成 Krea 2 风格
- 根据附图整理 Krea 2 提示词
